        ...
        enum  IMGSENSOR_POWER_ACTION_INDEX  pwr_actidx)
{
    ...
    if (pwr_actidx == IMGSENSOR_POWER_MATCHSENSOR_HWCFG_INDEX) {
        ...
        pr_info("[%s] match oplus_sensor_power_sequence\n", __func__);
            ...
            pr_info("[%s] enter for 20001 or 20075 IMGSENSOR_POWER_MATCHMIPI_HWCFG_INDEX \n", __func__);
            return NULL;
#endif
            ...
            pr_info("[%s] match 20682 IMGSENSOR_POWER_MATCHMIPI_HWCFG_INDEX \n", __func__);
#endif
...
void Oplusimgsensor_powerstate_notify(bool val)
{
    ...
    if (is_project(19131) || is_project(19132) || is_project(19133) || is_project(19420)
