...
struct IMGSENSOR_SENSOR_LIST
    gimgsensor_sensor_list_18161[MAX_NUM_OF_SUPPORT_SENSOR] = {
#if defined(IMX398_MIPI_RAW)
	{IMX398_SENSOR_ID, SENSOR_DRVNAME_IMX398_MIPI_RAW, IMX398_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3P9SP_MIPI_RAW)
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_18161[] = {
        {
                IMGSENSOR_SENSOR_IDX_MAIN,
                IMGSENSOR_I2C_DEV_0,
                {
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence_18161[] = {
#if defined(IMX398_MIPI_RAW)
	{
		SENSOR_DRVNAME_IMX398_MIPI_RAW,
		{
...
struct CAMERA_DEVICE_INFO gImgEepromInfo_18161 = {
    .i4SensorNum = 3,
    .pCamModuleInfo = {
        {IMX398_SENSOR_ID ,  0xA0, {0x00, 0x06}, 0xB0, 1, {0x92,0xFF,0xFF,0x94}, "Cam_r0", "imx398"},
        {S5K3P9SP_SENSOR_ID,  0xA8, {0x00, 0x06}, 0xE0, 0, {0xFF,0xFF,0xFF,0xFF}, "Cam_f", "s5k3p9sp"},
...
void oplus_imgsensor_hwcfg()
{
    ...
    } else if (is_project(18161) ) {
         oplus_gimgsensor_sensor_list = gimgsensor_sensor_list_18161;
         oplus_imgsensor_custom_config = imgsensor_custom_config_18161;
         oplus_sensor_power_sequence = sensor_power_sequence_18161;
         gImgEepromInfo = gImgEepromInfo_18161;
    } else {
         oplus_gimgsensor_sensor_list = gimgsensor_sensor_list_18531;
         oplus_imgsensor_custom_config = imgsensor_custom_config_18531;
