...
#define SENSOR_FUSION_THRESHOLD -26897500
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001));
            pr_info("s5k3p9sp_mipi_raw: read out sensor id 0x%x \n", *sensor_id);
            if (*sensor_id == imgsensor_info.sensor_id) {
                pr_info("s5k3p9sp_mipi_raw: i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                *sensor_id = S5K3P9SP_SENSOR_ID;
            ...
            pr_info("s5k3p9sp_mipi_raw: Read sensor id fail, id: 0x%x\n", imgsensor.i2c_write_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
